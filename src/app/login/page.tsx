    ...
    <div className="min-h-screen flex items-center justify-center p-6 bg-white">
      <div className="w-full max-w-[400px]">
        <div className="flex flex-col mb-8">
          ...
          <h1 className="text-[32px] font-bold text-[#1a1a1a] tracking-tight mb-2">Welcome Back</h1>
          <p className="text-[#666666] text-[16px]">To stay connected with us, please login with your personal information by email address and password</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="flex flex-col gap-5">
          ...
          <div className="flex items-center justify-between mt-1 mb-2">
            <div className="flex items-center">
              ...
              />
              <label htmlFor="remember" className="ml-2 text-[14px] text-[#4b5563]">
                Remember Me
              </label>
            </div>
            <a href="#" className="text-[14px] font-medium text-primary hover:text-primary-hover">
              Forgot password?
            </a>
          </div>
